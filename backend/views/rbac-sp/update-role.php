...
$this->params['breadcrumbs'][] = ['label' => ''.\Yii::t('app', 'QL nhóm quyền nhà cung cấp dịch vụ'), 'url' => ['role']];
                        ...
                        ['class' => 'yii\grid\ActionColumn',
                            ...
                            'buttons'=> [
                                'revoke' => function ($url, $model1, $key) {
                                    return Html::button('<i class="glyphicon glyphicon-remove-circle"></i> '.\Yii::t('app', 'Xóa'), [
                                        'type' => 'button',
