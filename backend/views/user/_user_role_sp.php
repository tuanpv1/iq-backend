...
<div class="portlet box green">
    <div class="portlet-title">
        <div class="caption"><i class="fa fa-globe"></i><?= \Yii::t('app', 'Quản phân quyền bên SP') ?></div>
    </div>
    ...
    <div class="portlet-body">
        ...
        <h3 class="form-section"><?= \Yii::t('app', 'Thêm nhóm quyền SP') ?></h3>
        <?php
        ...
        <div class="form-group">
            <?php
                ...
                echo Select2::widget([
                    ...
                    'data' => $data,
                    'options' => [
                        'placeholder' => ''.\Yii::t('app', 'Chọn nhóm quyền ...'),
                        'multiple' => true
                    ],
                ]);
            ?>
