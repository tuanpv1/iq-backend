...
$this->params['breadcrumbs'][] = ['label' => ''.\Yii::t('app', 'Quản lý nhóm quyền nhà cung cấp nội dung'), 'url' => ['role']];
...
<div class="row">
    ...
    $revokeUrl = \yii\helpers\Url::to(['rbac-cprovider/role-revoke-auth-item']);
        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body">
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($model, $key, $index, $widget) {
                                 ...
                                 * @var $model \common\models\AuthItem
                                 */
                                $action = $model->type == \common\models\AuthItem::TYPE_ROLE?'rbac-cprovider/update-role':'rbac-cprovider/update-permission';
                ...
                $form = ActiveForm::begin([
                    'id' => $formID,
                    'action' => ['rbac-cprovider/role-add-auth-item', 'name' => $model->name]
                ]);
                ?>
