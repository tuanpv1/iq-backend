...
/**
 * SumContentViewSearch represents the model behind the search form about `common\models\SumContentView`.
 */
class SumContentViewSearch extends SumContentView
{
    public $from_date;
    public $to_date;
    ...
    {
        return [
            [['id', 'site_id', 'content_provider_id', 'view_count', 'is_free', 'type', 'created_at', 'updated_at'], 'integer'],
            [['amount'], 'number'],
            [['report_date'], 'safe'],
            [['content_id'], 'safe'],
